  ...
  return (
    <div className='about'>
      <section>
        ...
        <p>
          I'm not your usual data analyst or data storyteller. 
          ...
          My favorite book is "Effective Data Storytelling" by Brent Dykes. My hunger for sharing valuable content has made me write articles and speak at different events on different data topics. 
